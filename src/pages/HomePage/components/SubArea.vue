...
<template>
  <section class="subarea">
    ...
    <div v-for="(cardItem, key) in props.subArea.cards" :key="key" class="card " grid grid-cols-4 h-20 rounded-2
      bg-gradient-to-r from-white to-gray-100 overflow-hidden mb-4>
